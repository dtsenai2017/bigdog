...
public class EnderecoCliente {
	...
	@Column(name = "id_endereco_cliente", nullable = false, columnDefinition = "bigint unsigned")
	...
	public String toString() {
		return "EnderecoCliente [idEnderecoCliente=" + idEnderecoCliente + ", cep=" + cep + ", logradouro=" + logradouro
