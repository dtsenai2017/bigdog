	...
	function listaCategoria(parametro) {
		$.ajax({
			type : "GET",
			url : "http://localhost:8080/BigDog/categoria/" + parametro,
			success : function(data) {
					for (i = 0; i < data.subCategorias.length; i++) {
						...
						a.href = 'produtos?idCategoria='
								+ data.idCategoria + "&idSubCategoria=" + data.subCategorias[i].idSubCategoria;
						console.log(a.href);
						li.innerHTML = data.subCategorias[i].subCategoria;
						a.append(li)
